...
class Attempt(models.Model):
    ...
    def __str__(self):return self.question.__str__()+' - '+self.player.__str__()
...
class Question(models.Model):
    ...
    def get_score(self):
        ...
        if total_attempts==0:score=1.0
        else: score=float(correct_attempts)/float(total_attempts)
        return score
...
class Answer(models.Model):
    ...
    def __str__(self):return self.question.__str__()
